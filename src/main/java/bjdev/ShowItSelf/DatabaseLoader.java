...
public class DatabaseLoader implements CommandLineRunner{
	...
	public void run(String... strings) throws Exception{
		...
		this.techniqueCardRepository.save(new TechniqueCard("Asciidoctor", "Asciidoctor is simular to mark down, but it has more compatable features such as making https page and binding pages. Doc page is generated by asciidoctor.", "asciidoctor"));
		this.techniqueCardRepository.save(new TechniqueCard("Nginx", "Nginx is web server like Apache. It provides lots of features including load balancing. It works as reverse-proxy and user only meet nginx.", "nginx"));
